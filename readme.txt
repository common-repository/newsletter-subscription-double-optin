...
= Plugin official download =

[Newsletter Plugin for Wordpress](http://www.sendblaster.com/wordpress-newsletter-double-optin-widget/ "newsletter plugin")
Please download here the newsletter plugin for Wordpress, since the SVN archive has broken links 
...
compatible with [big brain wordpress template](http://www.harrr.org/rrr/bigbrain/ "big brain wordpress template")
